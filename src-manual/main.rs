...
pub extern "C" fn rust_main() -> ! {
    ...
    println!("수동으로 작성된 Rust OS in 1,000 Lines 부팅 중...");
    
    // 메모리 초기화
    memory::init_memory(0x8000_0000, 1024 * 1024); // 1MB 힙 크기
...
fn execute_command(cmd: &[u8]) {
    ...
    match cmd_str {
        ...
        "version" => {
            println!("Rust OS in 1,000 Lines - 수동 구현 버전");
            println!("만든이: 사람");
        },
        "" => {}, // 빈 명령어
        _ => {
